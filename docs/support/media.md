...
This page contains a list of articles, blogs and newsletters that `vue-beautiful-dnd` has appeared in.

## Blogs by the `vue-beautiful-dnd` team
...
- [Design process for our new logo](https://www.maryannemade.com/VueBeautifulDnd-logo)
- [Overhauling our collision engine](https://dev.to/alexandereardon/overhauling-our-collision-engine-962)
- [vue-beautiful-dnd: behind the magic](https://www.youtube.com/watch?v=Kz50msV-zq0)
...
- [What does vue-beautiful-dnd cost to maintain?](https://dev.to/alexandereardon/what-does-vue-beautiful-dnd-cost-to-maintain-52e8)
...
- [Build a beautiful, draggable kanban board with vue-beautiful-dnd](https://www.youtube.com/watch?v=uHO3mQgs-e8)
- [Drag and Drop Tables with vue-beautiful-dnd (Part I)](https://dev.to/milandhar/drag-and-drop-table-with-vue-beautiful-dnd-54ad)
- [Scripted natural motion with vue-beautiful-dnd](https://dev.to/raathigesh/scripted-natural-motion-with-vue-beautiful-dnd-4ifj)
- [Drag n’Drop with vue-beautiful-dnd](https://medium.com/@reireynoso/drag-ndrop-with-vue-beautiful-dnd-73014e5937f2)
...
- [Building a Drag-and-Drop Game with vue-beautiful-dnd](https://able.bio/drenther/building-a-drag-and-drop-game-with-vue-beautiful-dnd--094r3g8)
- [Let's Create a Trello Clone with React + Redux](https://www.youtube.com/watch?v=RDQGPs7StNA)
- [Dynamically Update Positions During Drag Using vue-beautiful-dnd](https://itnext.io/dynamically-update-positions-during-drag-using-vue-beautiful-dnd-4a986d704c2e)
